...
export default function ForRelease() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://192.168.100.177:8001/api/dbcontrol/forRelease", {
    ...
    const updateStatus = async (roaId, reportId) => {
        try {
            ...
            const response = await axios.put(
                `http://192.168.100.177:8001/api/report/update/report/${roaId}`,
                { status: "Released" },
                { withCredentials: true }
            );
    ...
    const deleteReport = async (roaDataId) => {
        try {
            ...
            await axios.delete(`http://192.168.100.177:8001/api/report/delete/report/${roaDataId}`, {
                withCredentials: true,
            })
